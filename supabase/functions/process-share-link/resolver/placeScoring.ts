...
export function toResolvedCandidate(
  ...
  return {
    ...
    shortFormattedAddress: scored.candidate.shortFormattedAddress,
    primaryType: scored.candidate.primaryType,
    primaryTypeDisplayName: scored.candidate.primaryTypeDisplayName,
    googleMapsTypeLabel: scored.candidate.googleMapsTypeLabel,
    businessStatus: scored.candidate.businessStatus,
    confidenceScore,
