-- Reissue the idempotent technical-failure state repair under a unique version.
-- Dev migration history already contained 20260906000006 during rollout, but
-- live behavior proved the expected trigger was not installed there.
