// Pure Instagram content-identity contract shared by the Supabase metadata
// boundary and the media worker. Keep this module dependency-free: it is
// bundled by both Deno and Node.
