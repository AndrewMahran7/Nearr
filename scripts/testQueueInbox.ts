...
const needsHelp: QueueRow = { id: 'n1', status: 'needs_help', hasResolvedCandidate: true };
const needsSearch: QueueRow = { id: 'n2', status: 'needs_help', hasResolvedCandidate: false };
...
const alreadySaved: QueueRow = { id: 'n3', status: 'needs_help', hasResolvedCandidate: true, savedPlaceId: 'sp9' };
